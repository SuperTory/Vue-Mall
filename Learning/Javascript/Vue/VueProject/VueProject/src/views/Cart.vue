        ...
        <div class="container">
            <div class="cart">
                            ...
                            <li v-for="item in cartList">
                                <div class="cart-tab-1">
                                    <div class="cart-item-check">
                                        <a href="javascript:;" class="checkbox-btn item-check-btn" :class="{'check':item.checked}" @click="editCart('check',item)">
                                    ...
                                    <div class="item-quantity">
                                        <div class="select-self select-self-open">
                                            <div class="select-self-area">
                                                <a @click="editCart('sub',item)" class="input-sub">-</a>
                                                <span class="select-ipt">{{item.productNum}}</span>
                                                <a @click="editCart('add',item)" class="input-add">+</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cart-tab-5">
                                    <div class="cart-item-opration">
                                        <a href="javascript:;" @click="showConfirm(item.productId)" class="item-edit-btn">
                ...
                <div class="cart-foot-wrap">
                  ...
                  <span class="checkbox-btn item-check-btn" :class="{'check':allSelected}">
                      <svg class="icon icon-ok"><use xlink:href="#icon-ok"/></svg>
                        ...
                        <div class="cart-foot-r">
                            ...
                            <div class="btn-wrap">
                                <a @click="checkout" class="btn btn--red" :class="{'btn--dis':!noSelect}">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    computed:{
      ...
      allSelected(){
        ...
        this.cartList.forEach((item)=>{
          ...
          this.noSelect=this.noSelect||item.checked;
        });
